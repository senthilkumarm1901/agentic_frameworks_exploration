"""Strands Pattern 1 CLI entry point.

Runs a Strands agent connected to an MCP server for country-data queries.
"""
...
def main(argv=None):
    p = argparse.ArgumentParser(
        description="Augmented LLM pattern (Strands + MCP) - Country data Q&A"
    )
