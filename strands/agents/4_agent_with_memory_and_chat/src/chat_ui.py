...
Mirrors the LangGraph Pattern 4 chat_ui API so main.py stays framework-agnostic.
"""
...
def print_welcome(turn_count: int):
    ...
    print(f"\n{BOLD}{'═' * 60}{RESET}")
    print(f"{BOLD}  🌍 Country Analysis Agent — Interactive Chat (Strands){RESET}")
    print(f"{DIM}  Tools: country_lookup · calculator · kb_search{RESET}")
