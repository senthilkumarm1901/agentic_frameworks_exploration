"""Strands Pattern 3 CLI entry point."""
...
DEFAULT_QUESTION = "Compare the GDP and population of Japan and Germany. Which has higher GDP per capita?"
...
def main(argv=None):
    parser = argparse.ArgumentParser(
        description="Agent with MCP Tools and Skills (Strands) - Country data analysis"
    )
