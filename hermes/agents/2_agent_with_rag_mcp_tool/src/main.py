"""Hermes Pattern 2 CLI entry point.

Runs a Hermes-style ReAct agent connected to the Pattern 2 MCP server,
which adds country_kb_search_tool (semantic RAG) to the base two tools.
"""
...
DEFAULT_QUESTION = "What are the main geographic features of Australia?"
...
def main(argv=None):
    p = argparse.ArgumentParser(
        description="Hermes Pattern 2 — country data Q&A with RAG MCP tools"
    )
